...
#
# Script generated by Vivado on Mon Nov 17 18:47:13 -03 2025
...
#
# Usage        : sim.sh
#                sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sim.sh [-reset_run]
#                sim.sh [-reset_log]
#                sim.sh [-help]
#
...
#                script (type 'sim.sh -help' for more information).
#
...
# script info
echo -e "sim.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../2025.1/data/rsb/busdef" +incdir+"../../../aging-study.gen/sources_1/bd/design_1/ipshared/a9be" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../2025.1/data/rsb/busdef" +incdir+"../../../aging-study.gen/sources_1/bd/design_1/ipshared/a9be" \
  "../../../../../Vivado\\ Projects/aging-study/aging-study.srcs/sources_1/new/temp_catcher.v" \
  "../../../../../Vivado\\ Projects/aging-study/aging-study.srcs/sim_1/new/sim.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sim xil_defaultlib.glbl -o sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sim_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sim.sh [-help]\n\
Usage: sim.sh [-step]\n\
Usage: sim.sh [-lib_map_path]\n\
Usage: sim.sh [-reset_run]\n\
Usage: sim.sh [-reset_log]\n\
Usage: sim.sh [-keep_index]\n\
Usage: sim.sh [-noclean_files]\n\n\
