...
#
# Script generated by Vivado on Thu May 15 18:02:50 -03 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mirai/Documents/Projects/Aging_Fase2/failure_catch/aging_failure_holder/Aging-dynamic/vivado_project/aging-study/aging-study.cache/compile_simlib/vcs"
  fi
