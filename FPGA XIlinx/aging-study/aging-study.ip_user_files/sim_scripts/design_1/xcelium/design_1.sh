...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
  ...
  xmvlog -work util_vector_logic_v2_0_4 $xmvlog_opts +incdir+"../../../../aging-study.gen/sources_1/bd/design_1/ipshared/3cbc" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mirai/Documents/Projects/Aging_Fase2/failure_catch/aging_failure_holder/Aging-dynamic/vivado_project/aging-study/aging-study.cache/compile_simlib/xcelium"
  fi
