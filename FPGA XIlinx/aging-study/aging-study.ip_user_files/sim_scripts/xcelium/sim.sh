...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../2025.1/data/rsb/busdef" +incdir+"../../../aging-study.gen/sources_1/bd/design_1/ipshared/a9be" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../2025.1/data/rsb/busdef" +incdir+"../../../aging-study.gen/sources_1/bd/design_1/ipshared/a9be" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sim xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sim -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sim_sc.so .tmp_log xcelium_lib waves.shm c.obj)
