...
HD_PWD='/home/dan-alencar/Documents/GitHub/IC-Aging-Environment/aging_study_ultrascale/aging_study_ultrascale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aging_sensor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aging_sensor_top.tcl
