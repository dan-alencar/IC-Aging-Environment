...
HD_PWD='/home/dan-alencar/Documents/GitHub/IC-Aging-Environment/aging_study_ultrascale/aging_study_ultrascale.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aging_sensor_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aging_sensor_top.tcl -notrace
