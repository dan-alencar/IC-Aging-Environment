...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dan-alencar/Documents/GitHub/IC-Aging-Environment/sbcci_fpga_aging/sbcci_fpga_aging.cache/compile_simlib/xcelium"
  fi
