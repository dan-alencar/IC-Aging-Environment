...
#
# Script generated by Vivado on Sat Dec 27 19:14:06 -03 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../2025.2/data/rsb/busdef" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../sbcci_fpga_aging.gen/sources_1/ip/vio_0/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dan-alencar/Documents/GitHub/IC-Aging-Environment/sbcci_fpga_aging/sbcci_fpga_aging.cache/compile_simlib/vcs"
  fi
