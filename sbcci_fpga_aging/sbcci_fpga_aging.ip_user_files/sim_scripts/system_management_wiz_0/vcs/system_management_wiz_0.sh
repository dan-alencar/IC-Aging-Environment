...
#
# Script generated by Vivado on Tue Dec 23 16:59:25 -03 2025
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_management_wiz_0.sh
...
#
# Usage        : system_management_wiz_0.sh
#                system_management_wiz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_management_wiz_0.sh [-rerun]
#                system_management_wiz_0.sh [-reset_run]
#                system_management_wiz_0.sh [-clean]
#                system_management_wiz_0.sh [-reset_log]
#                system_management_wiz_0.sh [-help]
#
...
#                script (type 'system_management_wiz_0.sh -help' for more information).
#
...
# script info
echo -e "system_management_wiz_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_management_wiz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.system_management_wiz_0 xil_defaultlib.glbl -o system_management_wiz_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./system_management_wiz_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key system_management_wiz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_management_wiz_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_management_wiz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_management_wiz_0.sh [-help]\n\
Usage: system_management_wiz_0.sh [-step]\n\
Usage: system_management_wiz_0.sh [-lib_map_path]\n\
Usage: system_management_wiz_0.sh [-rerun]\n\
Usage: system_management_wiz_0.sh [-reset_run]\n\
Usage: system_management_wiz_0.sh [-clean]\n\
Usage: system_management_wiz_0.sh [-reset_log]\n\
Usage: system_management_wiz_0.sh [-keep_index]\n\
Usage: system_management_wiz_0.sh [-noclean_files]\n\n\
