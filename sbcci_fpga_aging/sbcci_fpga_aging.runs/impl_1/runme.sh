...
HD_PWD='/home/dan-alencar/Documents/GitHub/IC-Aging-Environment/sbcci_fpga_aging/sbcci_fpga_aging.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_unified_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_unified_top.tcl -notrace
